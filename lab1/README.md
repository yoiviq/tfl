...
Символ $p$ переписывается в $aba$, поэтому правила 1 и 3 можно заменить следующими правилами:

* $\texttt{babab} \to \texttt{abaababa}$
* $\texttt{aabaa} \to \texttt{bb}$

Далее, применяя алгортим Кнута-Бендикса с заменой этих правил, добавляем правило
